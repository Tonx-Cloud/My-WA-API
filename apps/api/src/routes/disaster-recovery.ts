...
import { DisasterRecoveryService, DisasterRecoveryConfig } from '../services/DisasterRecoveryService'
  ...
  try {
    ...
    const dashboard = {
      ...
      summary: {
        ...
        warningEvents: recentEvents.filter(e => e.severity === 'high' || e.severity === 'medium').length,
