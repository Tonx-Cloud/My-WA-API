...
describe('API Services - Comprehensive Test Suite', () => {
  ...
  describe('WhatsApp Service Integration', () => {
    ...
    it('should handle non-existent instance gracefully', async () => {
      ...
      await expect(mockWhatsAppService.getInstanceStatus('non-existent'))
  ...
  describe('Message Service Integration', () => {
    ...
    it('should handle service errors gracefully', async () => {
      ...
      await expect(mockWhatsAppService.sendMessage('test-instance', messageData))
  ...
  describe('Error Handling Scenarios', () => {
    it('should handle network timeouts', async () => {
      mockWhatsAppService.sendMessage.mockRejectedValue(
        new Error('ETIMEDOUT') as never
      )

      await expect(mockWhatsAppService.sendMessage('test-instance', {
        to: '+5511999999999',
        message: 'Hello',
        type: 'text'
    ...
    it('should handle invalid credentials', async () => {
      ...
      await expect(mockWhatsAppService.createInstance({
        name: 'Test',
    ...
    it('should handle service unavailable', async () => {
      ...
      await expect(mockWhatsAppService.getInstanceStatus('test-instance'))
