      ...
      const dashboard = {
        ...
        system: {
          ...
          memory: {
            ...
            percentage: Math.round((systemInfo.memory.heapUsed / systemInfo.memory.heapTotal) * 100)
          },
      ...
      const extendedHealth = {
        ...
        services: {
          ...
          ssl: {
            ...
            expiringSoon: sslService.getCertificates().filter(c => c.status === 'expiring-soon').length
          }
        }
      };
