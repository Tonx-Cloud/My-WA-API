  ...
  "inline-flex items-center justify-center font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-whatsapp-dark-500 hover:bg-whatsapp-dark-600 text-white focus:ring-whatsapp-dark-500",
        outline: "border-2 border-whatsapp-500 text-whatsapp-500 hover:bg-whatsapp-500 hover:text-white focus:ring-whatsapp-500",
  ...
  "bg-white border rounded-xl transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        whatsapp: "border-whatsapp-100 shadow-lg hover:shadow-xl bg-gradient-to-br from-white to-whatsapp-50",
      },
      padding: {
        none: "p-0",
        sm: "p-3",
...
export const StatusIndicator: React.FC<StatusIndicatorProps> = ({
  ...
  const statusConfig = {
    ...
    connecting: { color: 'bg-yellow-400', textColor: 'text-yellow-600', defaultLabel: 'Conectando...' },
    disconnected: { color: 'bg-gray-400', textColor: 'text-gray-600', defaultLabel: 'Desconectado' },
