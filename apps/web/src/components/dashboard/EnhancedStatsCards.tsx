...
export default function EnhancedStatsCards({ stats: propStats, showRealtime = true }: EnhancedStatsCardsProps) {
            ...
            <div>
              ...
              <div className="mt-2 text-sm text-red-700">
                ...
                <p className="mt-1 text-xs">
                  Os dados podem estar desatualizados. Verifique sua conexão com a internet e tente recarregar a página.
                </p>
              </div>
            </div>
          </div>
