...
export const MessageSenderOptimized: React.FC<MessageSenderProps> = ({ instances: propInstances }) => {
      ...
      <div className="space-y-6">
              ...
              {(() => {
                ...
                return (
                  <div className="flex items-center space-x-2">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getInstanceColor(instance.status)}`}>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder={
              messageType === 'text' 
                ...
                : 'https://exemplo.com/arquivo.' + (messageType === 'image' ? 'jpg' : messageType === 'document' ? 'pdf' : 'mp3')
            }
            rows={4}
          ...
          <div className="mt-1 flex justify-between text-sm text-gray-500">
            <span>
              {messageType === 'text' ? 'Máximo 4096 caracteres' : 'Informe a URL completa do arquivo'}
            </span>
