...
export default function MessageSender({ instances, onMessageSent }: MessageSenderProps) {
  ...
  }, [activeTab, selectedInstance, recipient, message, massRecipients, massMessage, validatePhoneNumber])

  const handleSendIndividual = useCallback(async (e: React.FormEvent) => {
    e.preventDefault()
  ...
  const handleSendMass = useCallback(async (e: React.FormEvent) => {
    e.preventDefault()
        ...
        <>
          {activeTab === 'individual' && (
            <form onSubmit={handleSendIndividual} className="space-y-4">
              <div>
                <label htmlFor="individual-instance" className="block text-sm font-medium text-gray-700 mb-2">
                  Instância
                </label>
                <select
              ...
              <div>
                <label htmlFor="individual-recipient" className="block text-sm font-medium text-gray-700 mb-2">
          ...
          {activeTab === 'mass' && (
            <form onSubmit={handleSendMass} className="space-y-4">
              <div>
                <label htmlFor="mass-instance" className="block text-sm font-medium text-gray-700 mb-2">
                  Instância
                </label>
                <select
                  id="mass-instance"
              ...
              <div>
                <label htmlFor="mass-recipients" className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <div>
                <label htmlFor="mass-message" className="block text-sm font-medium text-gray-700 mb-2">
                  Mensagem
                </label>
                <textarea
                  id="mass-message"
                ...
                <div className="flex justify-between items-center mt-1">
                  ...
                  <p className="text-xs text-gray-500">
                    {massMessage.length}/1000 caracteres
                  </p>
                </div>
              </div>
